(function ($) {
  ...
  // sites SLIDER
  var swiper = new Swiper('.sites-slider', {
    slidesPerView: 'auto',
    centeredSlides: true,
    spaceBetween: 30,
    breakpoints: {
 ...
 // SLIDER THUMBS
 var sitethumbs = new Swiper('.site-gallery-thumbs', {
  spaceBetween: 10,
  slidesPerView: 6,
  touchRatio: 0.2,
  slideToClickedSlide: true,
  ...
  // SLIDER
  var siteslider = new Swiper('.site-gallery-top', {
    slidesPerView: 1,
    spaceBetween: 0,
    autoplay: {
      delay: 9500,
 ...
 var testiSwiperOption = {
  ...
  var siteListSlider = new Swiper(".sites-list", PageSliderOptions)
  var PageSlider = new Swiper(".Page-slider .slider-track", PageSliderOptions)
  ...
  if ($('.js-cursor').length > 0) {
    ...
    $('a, .custom-button, .hamburger-menu, .equalizer, .swiper-pagination-bullet, .swiper-button-prev, .swiper-button-next, .main-nav button, submit[type="submit"], .sites-slider .site-detail h3').hover(function () {
